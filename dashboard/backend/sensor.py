"""Read the live sensor over serial for N seconds and return the averaged reading.

Mirrors the incoming format from src/pylogger.py: comma-separated lines
`ms,mq2,mq135,mq4,humidity,tempC` (6 fields). The header line and any malformed
line are skipped. The average of mq2/mq135/mq4/humidity/tempC becomes the model input.
"""
